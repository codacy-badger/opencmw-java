...
public class DataSourceExample {
    ...
    public static void main(String[] args) throws DirectoryLightClient.DirectoryClientException, URISyntaxException {
        ...
        dataSourcePublisher.subscribe(new URI("rda3://", address, '/' + DEV_NAME + '/' + PROP, "?ctx=" + SELECTOR + '&' + "acquisitionModeFilter=int:0" + '&' + "channelNameFilter=GS11MU2:Current_1@10Hz", null), CmwLightExample.AcquisitionDAQ.class);
        dataSourcePublisher.subscribe(new URI("rda3://", address2, '/' + DEV2_NAME + '/' + PROP, "?ctx=FAIR.SELECTOR.ALL" + '&' + "acquisitionModeFilter=int:4&channelNameFilter=GS02P:SumY:Triggered@25MHz", null), CmwLightExample.AcquisitionDAQ.class);
    }
}
